<div class="bg-white rounded-lg shadow-sm overflow-hidden mt-4">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-4 py-2">
        <h3 class="text-white font-bold text-center text-xs" data-ko="고객 지원" data-en="Customer Support" data-vi="Hỗ trợ khách hàng">고객 지원</h3>
    </div>
    ...
    <div class="p-3">
        <div class="grid grid-cols-2 gap-2">
            <a href="tel:031-431-4418" class="flex flex-col items-center justify-center bg-green-50 hover:bg-green-100 text-green-700 py-3 rounded-lg transition-colors duration-200">
                ...
                <span class="text-xs font-bold">+84 (0)388.221.216</span>
