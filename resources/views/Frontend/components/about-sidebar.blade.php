<div class="lg:col-span-1">
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden mb-8">
        ...
        <nav class="pb-4">
            @php
                $companyCategories = [
                    ['route' => 'about.greeting', 'ko' => '인사말', 'en' => 'Greeting', 'vi' => 'Lời chào', 'active' => true],
                    ['route' => 'about.organization', 'ko' => '조직도', 'en' => 'Organization', 'vi' => 'Sơ đồ tổ chức', 'active' => false],
                    ['route' => 'about.technology', 'ko' => '제조기술현황', 'en' => 'Technology Status', 'vi' => 'Tình trạng công nghệ', 'active' => false],
    ...
    @include('frontend.components.business-card')
</div>
