<div class="flex items-center justify-between mb-8 pb-4 border-b-2 border-gray-200">
    <div class="flex items-center">
        <h1 class="text-3xl font-bold text-blue-600 mr-4" data-ko="일반정반" data-en="General Surface Plate" data-vi="Bàn chuẩn chung">일반정반</h1>
    ...
    <div class="flex items-center space-x-2 text-sm text-gray-500">
        ...
        <span>></span>
        <span class="text-blue-600" data-ko="일반정반" data-en="General Surface Plate" data-vi="Bàn chuẩn chung">일반정반</span>
    </div>
</div>
