    ...
    <div class="block lg:hidden">
        <div class="bg-white rounded-lg shadow-sm p-4 mb-4">
            <div class="flex items-center justify-center mb-2">
                ...
                <h1 class="text-lg font-bold text-blue-600 text-center" data-ko="{{ $pageTitle }}" data-en="{{ $pageTitleEn }}" data-vi="{{ $pageTitleVi }}">{{ $pageTitle }}</h1>
            </div>
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between pb-4 border-b-2 border-gray-200">
            <div class="flex flex-col lg:flex-row lg:items-center mb-4 lg:mb-0">
                <div class="flex items-center mb-2 lg:mb-0">
                    ...
                    <h1 class="text-2xl lg:text-3xl font-bold text-blue-600 mr-0 lg:mr-4" data-ko="{{ $pageTitle }}" data-en="{{ $pageTitleEn }}" data-vi="{{ $pageTitleVi }}">{{ $pageTitle }}</h1>
                </div>
            ...
            <div class="flex items-center space-x-2 text-xs lg:text-sm text-gray-500 flex-wrap">
                ...
                <span>></span>
                <span data-ko="생산공정" data-en="Process" data-vi="Quy trình">생산공정</span>
                <span>></span>
                <span class="text-blue-600" data-ko="{{ $pageTitle }}" data-en="{{ $pageTitleEn }}" data-vi="{{ $pageTitleVi }}">{{ $pageTitle }}</span>
            </div>
        </div>
    </div>
</div>
