                    ...
                    <div class="content-page">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                <div class="card-grid-1 hover-up wow animate__animated animate__fadeIn" style="padding:0px">
                                    <div class="banner-hero banner-image-single" style="padding-top:0px">
                                        <img src="{{ \App\Helpers\CustomHelper::logoSrc($employer->background_img) }}" alt="jobbox" style="border-radius: 0px;height:112px;width:100%;object-fit:cover">
                                    </div>
                                    <div class="box-company-profile" style="padding-top:8px">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 text-start">
                                                <h5 class="f-18" style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">
                                                    <a href="{{ route('employers.show', $employer->slug) }}">
                                                        {{ $employer->company_name }}</a>
                                                </h5>
                                                <p class="mt-0 font-md color-text-paragraph-2 mb-5"><span class="card-location d-block">{{ $employer->address }}</span></p>
                                            </div>
                                            <div class="col-lg-12 col-md-12 text-lg-end p-0 mb-2"><a class="btn btn-apply btn-apply-big" href="{{ route('employers.show', $employer->slug) }}" style="padding: 15px 25px">{{ $employer->jobs_count }} Công việc</a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
