<div class="page-header page-header-light shadow">
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Home - <span class="fw-normal">@yield('pageTitle', 'Dashboard')</span>
            </h4>
            ...
            <div class="d-sm-flex align-items-center mb-3 mb-lg-0 ms-lg-3">
                <div class="dropdown w-100 w-sm-auto">
                    <a href="#" class="d-flex align-items-center text-body lh-1 dropdown-toggle py-sm-2"
                        ...
                        <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/tesla.svg"
                    ...
                    <div class="dropdown-menu dropdown-menu-lg-end w-100 w-lg-auto wmin-300 wmin-sm-350 pt-0">
                        ...
                        <a href="#" class="dropdown-item py-2">
                            <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/debijenkorf.svg"
                                class="w-32px h-32px me-2" alt="">
                            <div>
                        ...
                        <a href="#" class="dropdown-item py-2">
                            <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/klm.svg"
                                class="w-32px h-32px me-2" alt="">
                            <div>
                        ...
                        <a href="#" class="dropdown-item py-2">
                            <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/shell.svg"
                                class="w-32px h-32px me-2" alt="">
                            <div>
                        ...
                        <a href="#" class="dropdown-item py-2">
                            <img src="https://themes.kopyov.com/limitless/demo/template/assets/images/brands/bp.svg"
                                class="w-32px h-32px me-2" alt="">
                            <div>
    ...
    <div class="page-header-content d-lg-flex border-top">
        ...
        <div class="d-lg-block ms-lg-auto" id="breadcrumb_elements">
