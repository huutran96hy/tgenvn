            ...
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item nav-item-submenu">
                    ...
                    <ul class="nav-group-sub collapse">
                        ...
                        <li class="nav-item"><a
                                href="https://themes.kopyov.com/limitless/demo/template/LTR/material/full/index.html"
                                class="nav-link disabled">Material <span class="badge align-self-center ms-auto">Coming
                                    soon</span></a></li>
                        <li class="nav-item"><a
                                href="https://themes.kopyov.com/limitless/demo/template/LTR/clean/full/index.html"
                ...
                <li class="nav-item nav-item-submenu">
                    ...
                    <ul class="nav-group-sub collapse">
                        <li class="nav-item"><a
                                href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_static.html"
                                class="nav-link">Static layout</a></li>
                        <li class="nav-item"><a
                                href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_no_header.html"
                                class="nav-link">No header</a></li>
                        <li class="nav-item"><a
                                href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_no_footer.html"
                                class="nav-link">No footer</a></li>
                        <li class="nav-item-divider"></li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a href="https://themes.kopyov.com/limitless/demo/docs/other_changelog.html" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.job-categories.index') }}" class="nav-link {{ isActive('admin.job-categories.*') }}">
                        <i class="ph-table"></i>
